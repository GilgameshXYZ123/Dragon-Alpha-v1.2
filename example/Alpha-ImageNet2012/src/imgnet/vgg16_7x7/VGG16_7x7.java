 ...
 * @author Gilgamesh
 */
public class VGG16_7x7 extends Module
{
    Unit conv1 = nn.conv3D(false,  3, 64, 7, 1, 3);//7
    Unit conv2 = nn.conv3D(false, 64, 64, 7, 1, 3);//7
    Unit bn1 = nn.batchNorm_leakyRelu(nn.batchNorm(64), nn.leakyRelu());
    
    Unit conv3 = nn.conv3D(false,  64, 128, 7, 1, 3);//7
    Unit conv4 = nn.conv3D(false, 128, 128, 7, 1, 3);//7
    ...
    static String weight     =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG16_7x7.zip";
    static String opt_weight =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG16_7x7-opt.zip";
}
