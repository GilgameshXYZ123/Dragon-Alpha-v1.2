...
public class train 
{
    ...
    public static void train(int epoch) {
        VGG16_7x7 net = new VGG16_7x7().train().init(eg).println();
...
//        alpha.stat.load_zip(net, VGG16_7x7.weight);
//        alpha.stat.load_zip(opt, VGG16_7x7.opt_weight); 
        ...
        alpha.stat.save_zip(net, VGG16_7x7.weight); 
        alpha.stat.save_zip(opt, VGG16_7x7.opt_weight);
    }
