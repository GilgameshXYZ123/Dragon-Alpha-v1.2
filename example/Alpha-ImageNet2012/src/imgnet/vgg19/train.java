...
//        alpha.stat.load_zip(net, VGG19.weight);
//        alpha.stat.load_zip(opt, VGG19.opt_weight); 
        ...
        alpha.stat.save_zip(net, VGG19.weight); 
        alpha.stat.save_zip(opt, VGG19.opt_weight);
    }
