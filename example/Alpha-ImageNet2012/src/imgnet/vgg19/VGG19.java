...
public class VGG19 extends Module
{
    ...
    static String weight     =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG19.zip";
    static String opt_weight =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG19-opt.zip";
}
