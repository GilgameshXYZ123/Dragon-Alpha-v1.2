...
public class Net
{
    ...
    public static class ResNet18 extends Module {
        ...
        static String weight =      Config.weight_home + "Alpha-v1.1-imgnet2012-ResNet18.zip";
        static String opt_weight =  Config.weight_home + "Alpha-v1.1-imgnet2012-ResNet18-opt.zip";
    }
}
