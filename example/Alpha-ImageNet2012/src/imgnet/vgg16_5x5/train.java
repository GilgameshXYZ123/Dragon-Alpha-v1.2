...
public class train 
{
    ...
    public static void train(int epoch) {
        VGG16_5x5 net = new VGG16_5x5().train().init(eg).println();
...
//        alpha.stat.load_zip(net, VGG16_5x5.weight);
//        alpha.stat.load_zip(opt, VGG16_5x5.opt_weight); 
        ...
        alpha.stat.save_zip(net, VGG16_5x5.weight); 
        alpha.stat.save_zip(opt, VGG16_5x5.opt_weight);
    }
