...
public class VGG16_5x5 extends Module
{
    ...
    Unit conv10 = nn.conv3D(false, 512, 512, 5, 1, 2);
    Unit bn4 = nn.batchNorm_leakyRelu(nn.batchNorm(512), nn.leakyRelu());
    
    Unit conv11 = nn.conv3D(false, 512, 512, 5, 1, 2);
    Unit conv12 = nn.conv3D(false, 512, 512, 5, 1, 2);
    Unit conv13 = nn.conv3D(false, 512, 512, 5, 1, 2);
    ...
    static String weight     =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG16_5x5.zip";
    static String opt_weight =  Config.weight_home + "Alpha-v1.1-imgnet2012-VGG16_5x5-opt.zip";
}
