...
public class Adamod  extends Optimizer {
    ...
    public Adamod L1(float L1) { this.L1 = L1; return this; }
    
    public float L2() { return L2; }
    public Adamod L2(float L2) { this.L2 = L2; return this; }
    ...
    protected void __update__(int index, Tensor grad, Engine eg) {
        ...
        Tensor g = G[index];//exp_step
        boolean decay = (L1 != 0.0f) || (L2 != 0.0f);
        
        if(decay) eg.adamod(w, v, a1, a2, s, b1, b2, eps_t, g, c1, c2, grad, lr_t, L1, L2);
        else eg.adamod(w, v, a1, a2, s, b1, b2, eps_t, g, c1, c2, grad, lr_t);
    }
    ...
    protected void __update__(int index, Collection<Tensor> grads, Engine eg) {
        ...
        if(decay) eg.adamod(w, v, a1, a2, s, b1, b2, eps_t, g, c1, c2, grads, lr_t, L1, L2);
        else eg.adamod(w, v, a1, a2, s, b1, b2, eps_t, g, c1, c2, grads, lr_t);
    }
    ...
    protected void __clear__() {
        ...
        if(G != null) { Tensor.delete(G); G = null; }
    }
    //</editor-fold>
}
