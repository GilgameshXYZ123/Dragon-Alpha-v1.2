...
public class Adam extends Optimizer {
    ...
    public Adam L1(float L1) { this.L1 = L1; return this; }
    
    public float L2() { return L2; }
    public Adam L2(float L2) { this.L2 = L2; return this; }
    
    public boolean amsgrad() { return amsgrad; }
    public Adam amsgrad(boolean flag) { 
        this.amsgrad = flag; 
    ...
    protected void __update__(int index, Tensor grad, Engine eg) {
        ...
        if(amsgrad) {
            ...
            if(decay) eg.adam_amsgrad(w, v, a1, a2, s, b1, b2, eps_t, smax, grad, lr_t, L1, L2);
            else eg.adam_amsgrad(w, v, a1, a2, s, b1, b2, eps_t, smax, grad, lr_t);
            return;
        }
        
        if(decay) eg.adam(w, v, a1, a2, s, b1, b2, eps_t, grad, lr_t, L1, L2);
        else eg.adam(w, v, a1, a2, s, b1, b2, eps_t, grad, lr_t);
    }
    ...
    protected void __update__(int index, Collection<Tensor> grads, Engine eg) {
        ...
        if(amsgrad) {
            Tensor smax = Smax[index];
            if(decay) eg.adam_amsgrad(w, v, a1, a2, s, b1, b2, eps_t, smax, grads, lr_t, L1, L2);
            else eg.adam_amsgrad(w, v, a1, a2, s, b1, b2, eps_t, smax, grads, lr_t);
            return;
        }
        
        if(decay) eg.adam(w, v, a1, a2, s, b1, b2, eps_t, grads, lr_t, L1, L2);
        else eg.adam(w, v, a1, a2, s, b1, b2, eps_t, grads, lr_t);
    }
