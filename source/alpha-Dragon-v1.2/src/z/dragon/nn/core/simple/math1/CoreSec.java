 ...
 * @param <T>
 */
public class CoreSec<T extends SimpleUnit> extends SimpleCore<T>
{
    protected float alpha;
    protected float beta;

    public CoreSec(T unit, float alpha, float beta) {
        super(unit);
        this.alpha = alpha;
        this.beta = beta;
    }
    ...
    protected Tensor __forward__(Engine eg, Tensor X) {
        return eg.sec(false, alpha, X, beta);
    }
    ...
    protected Tensor __backward__(Engine eg, Tensor deltaY,
        ...
        return (backward_grads?
                eg.sec_deltaX(grad_inplace, deltaY, holdX(), alpha, beta):
                null);
    }
    //</editor-fold>
}
