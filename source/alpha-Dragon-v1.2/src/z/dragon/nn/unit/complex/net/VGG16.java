...
/**
 * The backone of VGG16 without stem and classifier.
 * @author Gilgamesh
 */
public class VGG16 extends Module {
    ...
    public Unit conv8 = nn.conv3D(false, 256, 512, 3, 1, 1);
    ...
    public VGG16(Unit activation, boolean batchNorm) {
        act = activation;
