 ...
 * @author Gilgamesh
 */
public class Linear2_Softplus extends DualFunction {
    private static final long serialVersionUID = 1L;
    
    protected boolean likeX1;
    protected float alpha, beta, gamma;
    
    public Linear2_Softplus(boolean likeX1, 
    ...
    public Linear2_Softplus likeX1(boolean flag) { likeX1 = flag; return this; }
    
    public final float alpha() { return alpha; }
    public Linear2_Softplus alpha(float alpha) { this.alpha = alpha; return this; }
    
    public final float beta() { return beta; }
    public Linear2_Softplus beta(float beta) { this.beta = beta; return this; }
    
    public final float gamma() { return gamma; }
    public Linear2_Softplus gamma(float gamma) { this.gamma = gamma; return this; }
    
    @Override
    protected InlineLinear2_Softplus create_unit_core() {
        return new InlineLinear2_Softplus(this);
    }
    //</editor-fold>
    ...
    public static class InlineLinear2_Softplus extends DualCore<Linear2_Softplus> {
        ...
        protected Tensor __forward__(Engine eg, Tensor X1, Tensor X2) {
            return eg.linear2_softplus(false, ut.likeX1, X1, X2, 
        ...
        protected Tensor[] __backward__(Engine eg, Tensor deltaY, 
            ...
            Tensor[] grads = (is_holdY()? //V1: holdY / V2: hold{X1, X2}
                    eg.linear2_softplus_deltaX_v1(grad_inplace, deltaY, holdY(), ut.alpha, ut.beta) :
                    eg.linear2_softplus_deltaX_v2(grad_inplace, deltaY, holdX1(), holdX2(), ut.alpha, ut.beta, ut.gamma));
