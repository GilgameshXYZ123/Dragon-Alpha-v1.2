 ...
 */
package z.dragon.nn.unit.simple.affine.leakyRelu;
 ...
 * @author Gilgamesh
 */
public class BatchNorm_LeakyRelu extends BatchNorm
{
    protected float k;

    public BatchNorm_LeakyRelu(boolean inplace, boolean affine, 
    ...
    public BatchNorm_LeakyRelu negative_slop(float negative_slope) { k = negative_slope; return this; }
    
    @Override public BatchNorm_LeakyRelu track_stats(boolean flag) { track_stats = flag; return this; }
      
    @Override public BatchNorm_LeakyRelu affine(boolean flag) { affine = flag; return this; }
    @Override public BatchNorm_LeakyRelu beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public BatchNorm_LeakyRelu beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public BatchNorm_LeakyRelu eps(float eps) { this.eps = eps; return this; }
    
    @Override public BatchNorm_LeakyRelu weight(Tensor weight) { set_weight(weight); return this; }
    @Override public BatchNorm_LeakyRelu bias(Tensor bias) { set_bias(bias); return this; }
    ...
    @Override public BatchNorm_LeakyRelu train() { this.training = true; return this; }
    @Override public BatchNorm_LeakyRelu eval() { this.training = false; return this; }
    
    @Override
    protected InlineBatchNorm_LeakyRelu<?> create_unit_core() {
        return new InlineBatchNorm_LeakyRelu<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineBatchNorm_LeakyRelu">
    public static class InlineBatchNorm_LeakyRelu<T extends BatchNorm_LeakyRelu> extends InlineBatchNorm<T>
    {
        public InlineBatchNorm_LeakyRelu(T unit) { super(unit); }
        ...
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace)  {
            ...
            Tensor Y = (ut.affine?
                    eg.batchNorm_leakyRelu(inplace, X, ut.dX_mean, ut.dX_var, ut.eps, ut.A.ts(), ut.B.ts(), ut.k) :
                    eg.batchNorm_leakyRelu(inplace, X, ut.dX_mean, ut.dX_var, ut.eps, ut.k));
        ...
        protected Tensor __backward_no_affine__(Engine eg, Tensor deltaY, 
            ...
            return (is_holdY() ? //V1: Y is not changed / V2: X is not changed
                    eg.batchNorm_leakyRelu_deltaX_v1(grad_inplace, deltaY, ut.k, holdY(), ut.dX_var, ut.eps) :
                    eg.batchNorm_leakyRelu_deltaX_v2(grad_inplace, deltaY, ut.k, holdX(), ut.dX_mean, ut.dX_var, ut.eps));
        }
