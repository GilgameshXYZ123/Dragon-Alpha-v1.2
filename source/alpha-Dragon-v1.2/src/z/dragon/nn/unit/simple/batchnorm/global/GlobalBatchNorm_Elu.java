 ...
 * Y = elu(global_batchNorm(X, A, B))
 * @author Gilgamesh
 */
@Passed("CudaFloat32Base")
public class GlobalBatchNorm_Elu extends GlobalBatchNorm {
    private static final long serialVersionUID = 1L;
    
    protected float alpha, k;

    public GlobalBatchNorm_Elu(boolean inplace, boolean affine, 
    ...
    public GlobalBatchNorm_Elu alpha(float alpha) { this.alpha = alpha; return this; }
    
    public final float negative_slop() { return k; }
    public GlobalBatchNorm_Elu negative_slop(float negative_slope) { k = negative_slope; return this; }
    
    @Override public GlobalBatchNorm_Elu affine(boolean flag) { affine = flag; return this; }
    @Override public GlobalBatchNorm_Elu beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public GlobalBatchNorm_Elu beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public GlobalBatchNorm_Elu eps(float eps) { this.eps = eps; return this; }
   
    @Override public GlobalBatchNorm_Elu weight(Tensor weight) { set_weight(weight); return this; }
    @Override public GlobalBatchNorm_Elu bias(Tensor bias) { set_bias(bias); return this; }
      
    @Override public GlobalBatchNorm_Elu run_mean(Tensor mean) { set_run_mean(mean); return this; }
    @Override public GlobalBatchNorm_Elu run_var(Tensor var) { set_run_var(var); return this; }
    
    @Override public GlobalBatchNorm_Elu train() { this.training = true; return this; }
    @Override public GlobalBatchNorm_Elu eval() { this.training = false; return this; }
    ...
    @Override
    protected InlineGlobalBatchNorm_Elu<?> create_unit_core() {
        return new InlineGlobalBatchNorm_Elu<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineGlobalBatchNorm_Elu">
    public static class InlineGlobalBatchNorm_Elu
            <T extends GlobalBatchNorm_Elu>extends InlineGlobalBatchNorm<T>
    {
        public InlineGlobalBatchNorm_Elu(T unit) { super(unit); }
        ...
        protected Tensor __backward_no_affine__(Engine eg, Tensor deltaY, 
            ...
            return (is_holdY() ? //V1: Y is not changed / V2: X is not changed
                    eg.batchNorm_elu_deltaX_v1(grad_inplace, deltaY, ut.alpha, ut.k, holdY(), 
                            ut.run_var.ts(), ut.eps):
                    eg.batchNorm_elu_deltaX_v2(grad_inplace, deltaY, ut.alpha, ut.k, holdX(),
