...
public class Affine_Gelu extends Affine implements Train2Eval {
    private static final long serialVersionUID = 1L;
    
    public Affine_Gelu(boolean inplace, int... feature_dim) { 
        super(inplace, feature_dim); 
    }
    
    //<editor-fold defaultstate="collapsed" desc="functions">
    @Override public Affine_Gelu weight(Tensor weight) { set_weight(weight); return this; }
    @Override public Affine_Gelu bias(Tensor bias) { set_bias(bias); return this; }
    
    protected boolean training = true;
    @Override public boolean training() { return training; }
    @Override public Affine_Gelu train() { training = true; return this; }
    @Override public Affine_Gelu eval() { training = false; return this; }
    ...
    @Override
    protected InlineAffine_Gelu<?> create_unit_core() {
        return new InlineAffine_Gelu<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineAffine_Gelu">
    public static class InlineAffine_Gelu<T extends Affine_Gelu> extends InlineAffine<T> 
    {
        public InlineAffine_Gelu(T unit) { super(unit); }
        
        //<editor-fold defaultstate="collapsed" desc="running-area: propagation"> 
        @Override
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace) {
            if(ut.training) inplace = false;
            return eg.affine_gelu(inplace, X, ut.A.ts(), ut.B.ts());
        }
        ...
        protected Tensor __backward__(Engine eg, Tensor deltaY, 
            ...
            if(ut.A.need_grads() || ut.B.need_grads()) {//A.need_grads = B.need_grads = true
                Tensor[] grads = eg.affine_gelu_deltaAB_v2(deltaY, 
            ...
            if(backward_grads) {
                deltaX = eg.affine_gelu_deltaX_v2(false, deltaY, 
                        holdX(),//V2: X is not changed, it's impossible to calculate gradeints in terms of y
                        ut.A.ts(), ut.B.ts());
