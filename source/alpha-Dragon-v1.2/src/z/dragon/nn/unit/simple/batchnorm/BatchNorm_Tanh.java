...
/**
 * Batch Normalization.
 * Y = tanh(batchNorm(X, A, B))
 * @author Gilgamesh
 */
@Passed("CudaFloat32Base")
public class BatchNorm_Tanh extends BatchNorm {
    private static final long serialVersionUID = 1L;

    public BatchNorm_Tanh(boolean inplace, boolean affine, 
    ...
    @Override public BatchNorm_Tanh track_stats(boolean flag) { track_stats = flag; return this; }
      
    @Override public BatchNorm_Tanh affine(boolean flag) { affine = flag; return this; }
    @Override public BatchNorm_Tanh beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public BatchNorm_Tanh beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public BatchNorm_Tanh eps(float eps) { this.eps = eps; return this; }
    
    @Override public BatchNorm_Tanh weight(Tensor weight) { set_weight(weight); return this; }
    @Override public BatchNorm_Tanh bias(Tensor bias) { set_bias(bias); return this; }
    
    @Override public BatchNorm_Tanh train() { this.training = true; return this; }
    @Override public BatchNorm_Tanh eval() { this.training = false; return this; }
    
    @Override
    protected InlineBatchNorm_Tanh<?> create_unit_core() {
        return new InlineBatchNorm_Tanh<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineBatchNorm_Tanh">
    public static class InlineBatchNorm_Tanh<T extends BatchNorm_Tanh> extends InlineBatchNorm<T>
    {
        public InlineBatchNorm_Tanh(T unit) { super(unit); }
        ...
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace)  {
            ...
            Tensor Y = (ut.affine?
                    eg.batchNorm_tanh(inplace, X, ut.dX_mean, ut.dX_var, ut.eps, ut.A.ts(), ut.B.ts()) :
                    eg.batchNorm_tanh(inplace, X, ut.dX_mean, ut.dX_var, ut.eps));
        ...
        protected Tensor __backward_no_affine__(Engine eg, Tensor deltaY, 
            ...
            return (is_holdY() ? //V1: Y is not changed / V2: X is not changed
                    eg.batchNorm_tanh_deltaX_v1(grad_inplace, deltaY, holdY(), ut.dX_var, ut.eps) :
                    eg.batchNorm_tanh_deltaX_v2(grad_inplace, deltaY, holdX(), ut.dX_mean, ut.dX_var, ut.eps));
        }
