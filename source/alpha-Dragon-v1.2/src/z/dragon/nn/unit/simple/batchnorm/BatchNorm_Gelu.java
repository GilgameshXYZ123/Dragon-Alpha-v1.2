...
public class BatchNorm_Gelu extends BatchNorm {
    private static final long serialVersionUID = 1L;
    
    public BatchNorm_Gelu(boolean inplace, boolean affine, 
    ...
    @Override public BatchNorm_Gelu track_stats(boolean flag) { track_stats = flag; return this; }
      
    @Override public BatchNorm_Gelu affine(boolean flag) { affine = flag; return this; }
    @Override public BatchNorm_Gelu beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public BatchNorm_Gelu beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public BatchNorm_Gelu eps(float eps) { this.eps = eps; return this; }
    
    @Override public BatchNorm_Gelu weight(Tensor weight) { set_weight(weight); return this; }
    @Override public BatchNorm_Gelu bias(Tensor bias) { set_bias(bias); return this; }
    
    @Override public BatchNorm_Gelu train() { this.training = true; return this; }
    @Override public BatchNorm_Gelu eval() { this.training = false; return this; }
    
    @Override
    protected InlineBatchNorm_Gelu<?> create_unit_core() {
        return new InlineBatchNorm_Gelu<>(this); 
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineBatchNorm_Gelu">
    public static class InlineBatchNorm_Gelu <T extends BatchNorm_Gelu>extends InlineBatchNorm<T>
    {
        public InlineBatchNorm_Gelu(T unit) { super(unit); }
        ...
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace)  {
            ...
            Tensor Y = (ut.affine?
                    eg.batchNorm_gelu(false, X, ut.dX_mean, ut.dX_var, ut.eps, ut.A.ts(), ut.B.ts()) :
                    eg.batchNorm_gelu(false, X, ut.dX_mean, ut.dX_var, ut.eps));
