...
public class Dropout extends SimpleInplaceFunction
        implements Train2Eval
{
    ...
    public static class InlineDropout extends SimpleInplaceInline<Dropout>
    {
        transient protected Tensor R;

        public InlineDropout(Dropout unit) { super(unit); }
