...
public class BernouliMul extends SimpleInplaceFunction
        implements Train2Eval
{
    ...
    public static class InlineBernouliMul extends SimpleInplaceInline<BernouliMul>
    {
        transient protected Tensor R;

        public InlineBernouliMul(BernouliMul unit) { super(unit); }
