...
public class Cot extends SimpleInplaceFunction {
    private static final long serialVersionUID = 562781240340001L;
    ...
    @Override
    protected InlineCot create_unit_core() {
        return new InlineCot(this);
    }
    //</editor-fold>

    //<editor-fold defaultstate="collapsed" desc="static class: InlineCot">
    public static class InlineCot extends SimpleInplaceInline<Cot> 
    {
        public InlineCot(Cot unit) { super(unit); }
        ...
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace) {
            return eg.cot(inplace, ut.alpha, X, ut.beta);
        }
        ...
        protected Tensor __backward__(Engine eg, Tensor deltaY, 
            ...
            return (backward_grads? 
                    eg.cot_deltaX(grad_inplace, deltaY, holdY(), ut.alpha):
                    null);
        }
        //</editor-fold>
    }
