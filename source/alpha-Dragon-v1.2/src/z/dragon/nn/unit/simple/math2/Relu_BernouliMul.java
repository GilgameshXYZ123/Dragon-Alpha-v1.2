...
public class Relu_BernouliMul extends SimpleInplaceFunction implements Train2Eval {
    ...
    public Relu_BernouliMul p(float p) { this.p = p; return this; }
    
    public final float v1() { return v1; }
    public Relu_BernouliMul v1(float v1) { this.v1 = v1; return this; }
    
    public final float v2() { return v2; }
    public Relu_BernouliMul v2(float v2) { this.v2 = v2; return this; }
    ...
    @Override public Relu_BernouliMul train() { this.training = true; return this; }
    @Override public Relu_BernouliMul eval() { this.training = false; return this; }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineBernouliMul">
    public static class InlineRelu_BernouliMul extends SimpleInplaceInline<Relu_BernouliMul>
    {
