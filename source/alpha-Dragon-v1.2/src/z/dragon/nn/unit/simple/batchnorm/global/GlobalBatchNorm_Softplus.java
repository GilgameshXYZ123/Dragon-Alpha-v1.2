 ...
 * Y = softplus(global_batchNorm(X, A, B))
 * @author Gilgamesh
 */
@Passed("CudaFloat32Base")
public class GlobalBatchNorm_Softplus extends GlobalBatchNorm {
    private static final long serialVersionUID = 1L;
    
    public GlobalBatchNorm_Softplus(boolean inplace, boolean affine, 
    ...
    @Override public GlobalBatchNorm_Softplus affine(boolean flag) { affine = flag; return this; }
    @Override public GlobalBatchNorm_Softplus beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public GlobalBatchNorm_Softplus beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public GlobalBatchNorm_Softplus eps(float eps) { this.eps = eps; return this; }
   
    @Override public GlobalBatchNorm_Softplus weight(Tensor weight) { set_weight(weight); return this; }
    @Override public GlobalBatchNorm_Softplus bias(Tensor bias) { set_bias(bias); return this; }
      
    @Override public GlobalBatchNorm_Softplus run_mean(Tensor mean) { set_run_mean(mean); return this; }
    @Override public GlobalBatchNorm_Softplus run_var(Tensor var) { set_run_var(var); return this; }
    
    @Override public GlobalBatchNorm_Softplus train() { this.training = true; return this; }
    @Override public GlobalBatchNorm_Softplus eval() { this.training = false; return this; }
    
    @Override
    protected InlineGlobalBatchNorm_Softplus<?> create_unit_core() {
        return new InlineGlobalBatchNorm_Softplus<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineGlobalBatchNorm_Softplus">
    public static class InlineGlobalBatchNorm_Softplus
            <T extends GlobalBatchNorm_Softplus>extends InlineGlobalBatchNorm<T>
    {
        public InlineGlobalBatchNorm_Softplus(T unit) { super(unit); }
        ...
        protected Tensor __backward_no_affine__(Engine eg, Tensor deltaY, 
            ...
            return (is_holdY() ? //V1: Y is not changed / V2: X is not changed
                    eg.batchNorm_softplus_deltaX_v1(grad_inplace, deltaY, holdY(), ut.run_var.ts(), ut.eps):
                    eg.batchNorm_softplus_deltaX_v2(grad_inplace, deltaY, holdX(), ut.run_mean.ts(), ut.run_var.ts(), ut.eps));
        }
