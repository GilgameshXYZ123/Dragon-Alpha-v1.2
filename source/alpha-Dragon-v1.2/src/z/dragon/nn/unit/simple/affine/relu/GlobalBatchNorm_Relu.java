 ...
 */
package z.dragon.nn.unit.simple.affine.relu;
 ...
 * @author Gilgamesh
 */
public class GlobalBatchNorm_Relu extends GlobalBatchNorm
{
    public GlobalBatchNorm_Relu(boolean inplace, boolean affine, 
    ...
    @Override public GlobalBatchNorm_Relu affine(boolean flag) { affine = flag; return this; }
    @Override public GlobalBatchNorm_Relu beta1(float beta1) { this.beta1 = beta1; return this; }
    @Override public GlobalBatchNorm_Relu beta2(float beta2) { this.beta2 = beta2; return this; }
    @Override public GlobalBatchNorm_Relu eps(float eps) { this.eps = eps; return this; }
   
    @Override public GlobalBatchNorm_Relu weight(Tensor weight) { set_weight(weight); return this; }
    @Override public GlobalBatchNorm_Relu bias(Tensor bias) { set_bias(bias); return this; }
      
    @Override public GlobalBatchNorm_Relu run_mean(Tensor mean) { set_run_mean(mean); return this; }
    @Override public GlobalBatchNorm_Relu run_var(Tensor var) { set_run_var(var); return this; }
    
    @Override public GlobalBatchNorm_Relu train() { this.training = true; return this; }
    @Override public GlobalBatchNorm_Relu eval() { this.training = false; return this; }
    
    @Override
    protected InlineGlobalBatchNorm_Relu<?> create_unit_core() {
        return new InlineGlobalBatchNorm_Relu<>(this);
    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="static class: InlineGlobalBatchNorm_Relu">
    public static class InlineGlobalBatchNorm_Relu
            <T extends GlobalBatchNorm_Relu>extends InlineGlobalBatchNorm<T>
    {
        public InlineGlobalBatchNorm_Relu(T unit) { super(unit); }
        ...
        protected Tensor __forward__(Engine eg, Tensor X, boolean inplace) {
            ...
            Tensor Y = (ut.affine?
                    eg.batchNorm_relu(false, X, ut.run_mean.ts(), ut.run_var.ts(), ut.eps, ut.A.ts(), ut.B.ts()) :
                    eg.batchNorm_relu(false, X, ut.run_mean.ts(), ut.run_var.ts(), ut.eps));
