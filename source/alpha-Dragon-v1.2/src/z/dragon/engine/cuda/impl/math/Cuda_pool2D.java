...
public final class Cuda_pool2D {
    ...
    public static final int max_streamsize = 4;
    
    public static final int nstream(int OH, int OW, int N, int IC) {
        ...
        int size = sn * sm;
        return (size <= max_streamsize ? size : max_streamsize);//the max stream size is 4
    }
    //</editor-fold>
    //<editor-fold defaultstate="collapsed" desc="Common">
    public static final int[] output_feature_dim(int IH, int IW, int FH, int FW, int N, int IC,
    ...
    public static final int[] input_feature_dim(int OH, int OW, int FH, int FW, int N, int IC,
            int sh, int sw, int ph, int pw) 
    {
    ...
    public static final int[] img2col_mat_dim(int FH, int FW, int OH, int OW, int N, int IC) {
        int GN = IC;
        int GM = N * OH * OW;
        int GK = FH * FW;
