...
public final class Cuda_matMul 
{
    ...
    public static final int blockNum(int N, int M) {//N%4, M%4 == 0
        int bn = 0,bm = 0;
        for(;;) {
    ...
    public static final int nstream(int N, int M) {//N%4, M%4 == 0
        int sn = 0, sm = 0;
        if((N & (N - 1)) == 0) sn = 1;
        else for(;;) {
     ...
     */
    @Passed
    public static native void matMulSK(long[] streamArray, int length,  int GZ,
            long dA_address, long dB_address, 
     ...
     * @param dB_address
     * @param dC_address
     * @param dC_buf_address
     * @param N N = A.height = C.height
     * @param M M = C.width = B.height
     * @param K K = A.width = B.width 
     */
    @Passed
    public static native void matMulT2SK(long[] streams, int length, int GZ,
            long dA_address,
            long dB_address, 
