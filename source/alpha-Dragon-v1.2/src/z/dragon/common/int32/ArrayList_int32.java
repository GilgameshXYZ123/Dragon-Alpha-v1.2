 ...
 * @author Gilgamesh
 */
public class ArrayList_int32 implements Serializable {
    ...
    private static final int[] DEFAULT_CAPACITY_EMPTY_ELEMENTDATA = {};
    
    public ArrayList_int32() { this.element = DEFAULT_CAPACITY_EMPTY_ELEMENTDATA; }
    public ArrayList_int32(int init_capacity) {
    ...
    protected int[] element; // non-private to simplify nested class access
    protected int size;
    ...
    public int[] toArray_int32() { return Arrays.copyOf(element, size); }
    ...
    private static int calculateCapacity(int[] elementData, int min_capacity) {
    ...
    public boolean addAll(ArrayList_int32 list) {
    ...
    private class Itr implements Iter_int32{
        ...
        public int next() {
            ...
            int[] elementData = ArrayList_int32.this.element;
        ...
        public void remove() {
            ...
            try {
                ArrayList_int32.this.remove(lastRet);
                cursor = lastRet;
                lastRet = -1;
    ...
    //</editor-fold>
    public Iter_int32 iterator() { return new Itr(); }
}
