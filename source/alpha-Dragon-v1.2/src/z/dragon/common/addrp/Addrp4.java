...
public class Addrp4 implements Addrpool
{
    ...
    @Override
    public final boolean put(long mem_size, long mem_address)  {
    ...
    @Override
    public final boolean remove(long mem_size, long mem_address)  {
    ...
    @Override
    public final long[] remove_ceiling(long min_mem_size)//mem_size >= min_mem_size
    {
        LinkedList_int64 block_list; long block_size, block_address;
    ...
    @Override
    public final long[] remove_floor(long max_mem_size)//mem_size <= min_mem_size
    {
        LinkedList_int64 block_list; long block_size, block_address;
    ...
    @Override
    public final long[] remove_section(long min_mem_size, long max_mem_size) 
    {   
        LinkedList_int64 block_list; long block_size, block_address;
