...
public class State extends HashMap<String, StateValue>
{
    ...
    public static FloatArrayValue floats(float... vals) { return new FloatArrayValue(vals); }
    public static IntArrayValue ints(int... vals) { return new IntArrayValue(vals); }
}
