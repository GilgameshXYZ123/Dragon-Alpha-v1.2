 ...
 */
package winograd.W5_f4x5;

/**
 *
 * @author Gilgamesh
 */
public class Winograd_f4x5_v1 
{
    // AT*((G*g)(BT*d))
            ...
            int ph, int pw)//sh = sw = 1
    {
        ...
        for(int ow=0; ow<OW; ow+= 4)
        {
            ...
            for(int ic=0; ic<IC; ic++)
            {
                ...
                float g0 = w0;// ⎡ 1      0     0      0      0   ⎤
                float g1 = -0.22222222f * (w0 + w1 + w2 + w3 + w4);//⎢-2/9   -2/9   -2/9  -2/9   -2/9 ⎥
                float g2 = -0.22222222f * (w0 - w1 + w2 - w3 + w4);//⎢-2/9    2/9   -2/9   2/9   -2/9 ⎥
                float g3 = 0.011111111f*w0 + 0.022222222f*w1 + 0.044444444f*w2 + 0.08888889f*w3 + 0.17777778f *w4;//⎢ 1/90   1/45  2/45   4/45   8/45⎥
                float g4 = 0.011111111f*w0 - 0.022222222f*w1 + 0.044444444f*w2 - 0.08888889f*w3 + 0.17777778f *w4;//⎢ 1/90  -1/45  2/45  -4/45   8/45⎥
                float g5 = 0.7111111f  *w0 + 0.35555556f *w1 + 0.17777778f *w2 + 0.08888889f*w3 + 0.044444444f*w4;//|32/45  16/45  8/45   4/45   2/45|
                float g6 = 0.7111111f  *w0 - 0.35555556f *w1 + 0.17777778f *w2 - 0.08888889f*w3 + 0.044444444f*w4;//|32/45 -16/45  8/45  -4/45   2/45|
                float g7 = w4;//⎣ 0      0      0       0     1  ⎦
            ...
            float v3 =      a1 - a2 +  8*a3 -  8*a4 + 0.125f  *a5 - 0.125f  *a6 + a7;//⎣0  1  -1   8  -8   1/8  -1/8   1⎦
