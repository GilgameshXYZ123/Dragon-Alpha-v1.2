...
//                float g7 = w2;                             //   0,    0,     1,
                ...
                float g3 = (1.0f / 90) * (w0 + 2*w1 + 4*w2);//1/90,  1/45, 2/45,
                float g4 = (1.0f / 90) * (w0 - 2*w1 + 4*w2);//1/90, -1/45, 2/45,
                float g5 = (32.0f/45)*w0 + ( 16.0f/45)*w1 + (8.0f/45)*w2;
                float g6 = (32.0f/45)*w0 + (-16.0f/45)*w1 + (8.0f/45)*w2;
                float g7 = w2;                             //   0,    0,     1,
            ...
            float v1 = a1 - a2 +  2*a3 -  2*a4 + (1.0f/ 2)*a5 + (-1.0f/ 2)*a6;     // ⎢0  1  -1  2   -2   1/2   -1/2   0⎥
            float v2 = a1 + a2 +  4*a3 +  4*a4 + (1.0f/ 4)*a5 + ( 1.0f/ 4)*a6;     // ⎢0  1  1   4    4   1/4    1/4   0⎥
            float v3 = a1 - a2 +  8*a3 -  8*a4 + (1.0f/ 8)*a5 + (-1.0f/ 8)*a6;     // ⎢0  1  -1  8   -8   1/8   -1/8   0⎥
            float v4 = a1 + a2 + 16*a3 + 16*a4 + (1.0f/16)*a5 + ( 1.0f/16)*a6;     // ⎢0  1  1   16  16   1/16  1/16   0⎥
            float v5 = a1 - a2 + 32*a3 - 32*a4 + (1.0f/32)*a5 + (-1.0f/32)*a6 + a7;// ⎣0  1  -1  32  -32  1/32  -1/32  1⎦
