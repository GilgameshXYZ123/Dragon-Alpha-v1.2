 ...
 * @author Gilgamesh
 */
public class Winograd_f14x3_v8 
{
            ...
            int ph, int pw)//sh = sw = 1
    {
        ...
        for(int ow=0; ow<OW; ow+= 14)
        {
            ...
            float  t1 =  a1 +  a2,  t2 =  a1 -  a2;
            float  t3 =  a3 +  a4,  t4 =  a3 -  a4;
            float  t5 =  a5 +  a6,  t6 =  a5 -  a6;
            float  t7 =  a7 +  a8,  t8 =  a7 -  a8;
            float  t9 =  a9 + a10, t10 =  a9 - a10;
            float t11 = a11 + a12, t12 = a11 - a12;
            float t13 = a13 + a14, t14 = a13 - a14;
            ...
            float  y3 = t2 +    8.0f*t4 + 0.125f      *t6 +      27.0f*t8 + 0.03703704f *t10 +       64.0f*t12 + 0.015625f   *t14;
            float  y4 = t1 +   16.0f*t3 + 0.0625f     *t5 +      81.0f*t7 + 0.01234568f  *t9 +      256.0f*t11 + 0.00390625f *t13;
            float  y5 = t2 +   32.0f*t4 + 0.03125f    *t6 +     243.0f*t8 + 0.004115226f*t10 +     1024.0f*t12 + 9.765625E-4f*t14;
            float  y6 = t1 +   64.0f*t3 + 0.015625f   *t5 +     729.0f*t7 + 0.001371742f* t9 +     4096.0f*t11 + 2.441406E-4f*t13;
            float  y7 = t2 +  128.0f*t4 + 0.0078125f  *t6 +    2187.0f*t8 + 4.572474E-4f*t10 +    16384.0f*t12 + 6.103516E-5f*t14;
            float  y8 = t1 +  256.0f*t3 + 0.00390625f *t5 +    6561.0f*t7 + 1.524158E-4f* t9 +    65536.0f*t11 + 1.525879E-5f*t13;
            float  y9 = t2 +  512.0f*t4 + 0.001953125f*t6 +   19683.0f*t8 + 5.080526E-5f*t10 +   262144.0f*t12 + 3.814697E-6f*t14;
            float y10 = t1 + 1024.0f*t3 + 9.765625E-4f*t5 +   59049.0f*t7 + 1.693509E-5f* t9 +  1048576.0f*t11 + 9.536743E-7f*t13;
            float y11 = t2 + 2048.0f*t4 + 4.882812E-4f*t6 +  177147.0f*t8 + 5.645029E-6f*t10 +  4194304.0f*t12 + 2.384186E-7f*t14;
            float y12 = t1 + 4096.0f*t3 + 2.441406E-4f*t5 +  531441.0f*t7 + 1.881676E-6f* t9 + 1.677722E7f*t11 + 5.960464E-8f*t13;
            float y13 = t2 + 8192.0f*t4 + 1.220703E-4f*t6 + 1594323.0f*t8 + 6.272255E-7f*t10 + 6.710886E7f*t12 + 1.490116E-8f*t14 + a15;
            
            float d[] = new float[16], x[] = new float[16];
	...
	t1 =  4.0f*x[1] - 57.69444f*x[3] + 219.9236f*x[5] - 229.8542f*x[7] + 70.96528f*x[ 9] - 7.590278f*x[11] + 0.25f*x[13];
	t2 = 16.0f*x[2] - 230.7778f*x[4] + 879.6944f*x[6] - 919.4167f*x[8] + 283.8611f*x[10] - 30.36111f*x[12] +       x[14];
