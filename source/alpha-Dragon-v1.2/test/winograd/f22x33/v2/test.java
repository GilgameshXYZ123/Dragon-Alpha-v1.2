...
public class test 
{
	...
	int sizeY = N*OC*OH*OW;
        ...
        //Winograd--------------------------------------------------------------
        Winograd2D_f22x33_a1.winograd(cX, IH, IW, cW, cY2, OH, OW, N, IC, OC, ph, pw);
        
        //Winograd2D_f22x33_v0.check_idx(cY2, N, OH, OW, OC);
    ...
    {
        int IW = 32;
        int tiles_dim = (int) Math.ceil(Math.ceil((double)(IW + 2) / 2) - 1);
        System.out.println(tiles_dim);
