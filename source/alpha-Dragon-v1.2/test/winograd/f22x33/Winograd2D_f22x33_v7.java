 ...
 * @author Gilgamesh
 */
public class Winograd2D_f22x33_v7 
{
            ...
            int ph, int pw)//sh = sw = 1
    {
        ...
        for(int ow=0; ow<OW; ow += 2)
        {
            ...
            for(int ic=0; ic<IC; ic++) 
            {
                ...
                //load x(4*4)
                d[0][0] = X[n][ih    ][iw][ic]; d[0][1] = X[n][ih    ][iw + 1][ic]; d[0][2] = X[n][ih    ][iw + 2][ic]; d[0][3] = X[n][ih    ][iw + 3][ic]; 
                d[1][0] = X[n][ih + 1][iw][ic]; d[1][1] = X[n][ih + 1][iw + 1][ic]; d[1][2] = X[n][ih + 1][iw + 2][ic]; d[1][3] = X[n][ih + 1][iw + 3][ic];
                d[2][0] = X[n][ih + 2][iw][ic]; d[2][1] = X[n][ih + 2][iw + 1][ic]; d[2][2] = X[n][ih + 2][iw + 2][ic]; d[2][3] = X[n][ih + 2][iw + 3][ic];
                d[3][0] = X[n][ih + 3][iw][ic]; d[3][1] = X[n][ih + 3][iw + 1][ic]; d[3][2] = X[n][ih + 3][iw + 2][ic]; d[3][3] = X[n][ih + 3][iw + 3][ic];    
                __sync_threads();
                
                //input transform-----------------------------------------------
                float b00 = d[0][0] - d[2][0], b01 = d[0][1] - d[2][1], b02 = d[0][2] - d[2][2], b03 = d[0][3] - d[2][3];
                
                float b10 = d[1][0] + d[2][0], b11 = d[1][1] + d[2][1], b12 = d[1][2] + d[2][2], b13 = d[1][3] + d[2][3];
                
                float b20 = d[2][0] - d[1][0], b21 = d[2][1] - d[1][1], b22 = d[2][2] - d[1][2], b23 = d[2][3] - d[1][3];
                
                float b30 = d[1][0] - d[3][0], b31 = d[1][1] - d[3][1], b32 = d[1][2] - d[3][2], b33 = d[1][3] - d[3][3];
                __sync_threads();
