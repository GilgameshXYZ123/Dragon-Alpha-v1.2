 ...
 * @author Gilgamesh
 */
public class Winograd2D_f22x33_v9 
{
            ...
            int ph, int pw)//sh = sw = 1
    {
        ...
        for(int ow=0; ow<OW; ow += 2)
        {
            ...
            for(int ic=0; ic<IC; ic++) 
            {
                ...
                //input transform-----------------------------------------------
                d[0][0] = b[0][0] - b[0][2]; d[0][1] = b[0][1] + b[0][2]; d[0][2] = b[0][2] - b[0][1]; d[0][3] = b[0][1] - b[0][3];
                d[1][0] = b[1][0] - b[1][2]; d[1][1] = b[1][1] + b[1][2]; d[1][2] = b[1][2] - b[1][1]; d[1][3] = b[1][1] - b[1][3];
                d[2][0] = b[2][0] - b[2][2]; d[2][1] = b[2][1] + b[2][2]; d[2][2] = b[2][2] - b[2][1]; d[2][3] = b[2][1] - b[2][3];
                d[3][0] = b[3][0] - b[3][2]; d[3][1] = b[3][1] + b[3][2]; d[3][2] = b[3][2] - b[3][1]; d[3][3] = b[3][1] - b[3][3];
                 __sync_threads();
