...
public class Cuda_function_batchnorm_test5 
{
	...
	int lengthv = height * 2 * 3 * stride;
        ...
        float[] A = Vector.random_float_vector(width, 0, 1f);
        float[] B = Vector.random_float_vector(width, 0, 1f);
        ...
        float sp0 = Vector.samePercent_absolute(dX1, dX2);
        float sp1 = Vector.samePercent_absolute(dA1, dA2);
        float sp2 = Vector.samePercent_absolute(dB1, dB2);
