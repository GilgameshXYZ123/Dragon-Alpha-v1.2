...
//        float[] X = Vector.randomFloatVector(length, 0, 1f);
        float[] X = Vector.random_float_vector(length, 0, 0.001f);
        ...
        float sp0 = Vector.samePercent_relative(dX1, dX2);
        float sp1 = Vector.samePercent_relative(dA1, dA2);
        float sp2 = Vector.samePercent_relative(dB1, dB2);
