 ...
 * @author Gilgamesh
 */
public class Cuda_img_function_test_field1 
{
	...
	int lengthv = height * stride;
        ...
        //CPU-------------------------------------------------------------------
        byte[] Y1 = Vector.img_linear2_row(X, X2, alpha1, beta1, gamma, height, width);
        
        System.out.print("CPU : "); Vector.println(Y1, 0, 10);
        
        //GPU-------------------------------------------------------------------
        Tensor tY1 = eg.img.linear2_row(false, tX, tX1, alpha1, beta1, gamma);
        Tensor tY2 = eg.img.linear2_row(true, tX, tX1, alpha1, beta1, gamma);
