...
//        ----------------------------------------------------------------------
//        Tense.pool2D_max_img2col(cX, IH, IW, FH, FW, cY, OH, OW, N, IC, sh, sw, ph, pw);//A
...
//        Tensor tY1 = eg.pool2D_avg(false, tX, FH, FW, sh, sw, ph, pw).c();
//        Tensor tY2 = eg.pool2D_avg(false, eg.empty(N, OH, OW, IC).c(), tX, FH, FW, ph, pw, sh, sw).c();
    
        Tensor tY1 = eg.pool2D_max(tX, FH, FW, sh, sw, ph, pw).c();
        Tensor tY2 = eg.pool2D_max(eg.empty(N, OH, OW, IC).c(), tX, FH, FW, sh, sw, ph, pw).c();
...
//            tY = eg.pool2D_avg(tY, tX, FH, FW, sh, sw);
        ...
        long div=timer.timeStamp_dif_millis();
