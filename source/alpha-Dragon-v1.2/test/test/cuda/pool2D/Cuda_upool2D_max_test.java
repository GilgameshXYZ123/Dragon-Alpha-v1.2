...
public class Cuda_upool2D_max_test 
{
            ...
            int sh, int sw, int ph, int pw)
    {
        ...
        //GPU------------------------------------------------------------------
        Tensor tdeltaX1 = eg.unpool2D_max(eg.empty(N, IH, IW, IC).c(), tdeltaY, tY, tX, FH, FW, sh, sw).c();
        Tensor tdeltaX2 = eg.unpool2D_max(tdeltaY, tY, tX, FH, FW, sh, sw, ph, pw).c();
            ...
            int sh, int sw, int ph, int pw)
    {
        ...
        float[] deltaX = Vector.random_float_vector(sizeX);
        float[] X = Vector.random_float_vector(sizeX);
        float[] Y = Vector.random_float_vector(sizeY);
...
//            tdeltaX = eg.upool2D_max(tdeltaY, tY, tX, FH, FW, sh, sw, ph, pw).sync(); eg.delete(tdeltaX);
            tdeltaX = eg.unpool2D_max(tdeltaX, tdeltaY, tY, tX, FH, FW, sh, sw);
        }
