...
//        Tensor tdeltaX2 = eg.upool2D_avg(eg.empty(N, IH, IW, IC), tdeltaY, FH, FW, sh, sw).c();
        ...
        Tensor tdeltaX1 = eg.unpool2D_avg(true, tdeltaY, FH, FW, sh, sw, ph, pw).c();
        Tensor tdeltaX2 = eg.unpool2D_avg(true, eg.empty(N, IH, IW, IC).c(), tdeltaY, FH, FW, sh, sw).c();
...
//            tdeltaX = eg.upool2D_avg(tdeltaY, FH, FW, sh, sw, ph, pw).sync(); eg.delete(tdeltaX);
            tdeltaX = eg.unpool2D_avg(true, tdeltaX, tdeltaY, FH, FW, sh, sw);
        }
