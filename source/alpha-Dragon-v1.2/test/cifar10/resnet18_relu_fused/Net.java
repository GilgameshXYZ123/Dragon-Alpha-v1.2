 ...
 */
package cifar10.resnet18_relu_fused;
...
public class Net
{
    public static class BasicBlock extends Module {
        ...
        public BasicBlock(int in_channel, int out_channel, int stride) {
           ...
           bn1 = nn.batchNorm_relu(nn.batchNorm(out_channel), nn.relu());
    ...
    public static class ResNet18 extends Module {
        Unit prepare = nn.sequence(//div2, channel = 64
                ...
                nn.batchNorm_relu(nn.batchNorm(64), nn.relu())
        );
        ...
        Unit fc = nn.sequence(
                ...
                nn.relu_dropout(nn.relu(), nn.dropout(0.9f)),
