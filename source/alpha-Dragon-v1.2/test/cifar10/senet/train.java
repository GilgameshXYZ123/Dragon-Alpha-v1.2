...
import cifar10.senet.Net.SENet;
import static cifar10.senet.Net.SENet.eg;
...
public class train {
    ...
    public static void training(int epoch) {
        ...
        Optimizer opt = alpha.optim.Adam(net.params(), lr);//30 epoch
...
//               
        ...
        System.out.println("total = " + (1.0 * div / 1000));
