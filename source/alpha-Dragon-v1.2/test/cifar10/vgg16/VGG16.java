...
public class VGG16 extends Module
{
    ...
    Unit conv8 = nn.conv3D(false, 256, 512, 3, 1, 1);//28
    ...
    Unit conv11 = nn.conv3D(false, 512, 512, 3, 1, 1);//14
    ...
    public Tensor[] __forward__(Tensor... X) {
        ...
        X = F.leakyRelu(conv11.forward(X));//div32: 512 -> 512
    ...
    String weight = "C:\\Users\\Gilgamesh\\Desktop\\Alpha-v1.1-VGG16-cifar10.zip";
