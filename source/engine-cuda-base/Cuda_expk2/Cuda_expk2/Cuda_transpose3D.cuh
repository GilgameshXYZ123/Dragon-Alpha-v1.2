...
#define tp3d_k1(stream, LB, LT, X, Y, Xd1, Xd2, Yd1, Yd2, dIdx1, dIdx2, strideX, strideY, lengthv)\
	transpose3D_kernel_1\
		<<< (length >> LB >> LT), (1<<LB), 0, stream>>>\
			(X, Y, Xd1, Xd2, Yd1, Yd2, dIdx1, dIdx2, strideX, strideY, lengthv)

#define tp3d_k1_small(stream, X, Y, Xd1, Xd2, Yd1, Yd2, dIdx1, dIdx2, strideX, strideY, lengthv)\
	transpose3D_kernel_1\
	...
	int length)
{
	...
	if (dIdx2 < 2) {//no change to basic mem structure
		...
		if (lengthv < 256) { tp3d_k4_small(stream, X, Y, Xd1, Yd1, dIdx1, dIdx2, strideX, lengthv); return; }
