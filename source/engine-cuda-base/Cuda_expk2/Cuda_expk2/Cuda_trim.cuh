...
#include "Cuda_trim2D.cuh"
#include "Cuda_trim3D.cuh"
#include "Cuda_trim4D.cuh"

//Method:    trim2D
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_Cuda_1expk2_trim2D(JNIEnv *env, jclass cls,
...
//Method:    trim3D
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_Cuda_1expk2_trim3D(JNIEnv *env, jclass cls,
	jlong stream_address,
...
//Method:    trim4D
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_Cuda_1expk2_trim4D(JNIEnv *env, jclass cls,
	jlong stream_address,
