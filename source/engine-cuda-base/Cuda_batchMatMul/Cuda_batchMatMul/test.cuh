...
void testCorrectT2(int Batch, int N, int BM, int K)
{
	...
	//bmmT2_k88v(NULL, LB, 0, 0, dA, dB, dC, Batch, N, CM, BM, K, N, CM);
...
main()
{
	...
	//int Batch = 1, N = 1024, M = 1024, K = 1024;
	...
	//testCorrect<4, 1, 1>(Batch, N, M, K + 8);
	//testCorrect<4, 1, 1>(Batch, N, M, K);
	//testSpeed<4, 1, 1>(1000, Batch, N*2, M*2, K*2);
	
	//testCorrectT1<4, 1, 1>(Batch, N, M, K);
	//testCorrectT1<4, 1, 1>(Batch, N, M, K + 4);
	//testSpeedT1<4, 1, 1>(1000, Batch, N*2, M*2, K*2);

	testCorrectT2<4, 1, 1>(Batch, N, M, K);
	//testCorrectT2<4, 1, 1>(Batch, N, M, K - 16);
	//testCorrectT2<3, 1, 1>(Batch, N, M, K - 4);
	testSpeedT2<4, 1, 1>(1000, Batch, N*2, M*2, K*2);
