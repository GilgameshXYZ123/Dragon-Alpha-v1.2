...
#ifndef MICRO_WINOGRAD_F9X8_H
#define MICRO_WINOGRAD_F9X8_H

const bool enable_Winograd_F9X8 = true;

//======{ Filtrer-Transform: W(8) -> G(16) }==========
//with less multiplication
#define winograd_f9x8_G(g, w) {\
	float t1, t2;\
	g[0] = w[0];\
...
#define winograd_f9x8_D_oft(d, x, oft) {\
	float t1, t2;\
...
#define winograd_f9x8_Y(y, a) {\
	...
	y[ 8] = t1 +  256.0f*t3 + 0.00390625f *t5 +    6561.0f*t7 + 1.524158E-4f* t9 +    65536.0f*t11 + 1.525879E-5f*t13 + a[15];}
