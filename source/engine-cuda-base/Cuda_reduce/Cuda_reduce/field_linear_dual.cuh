...
#ifndef FIELD_LINEAR_DUAL_KERNEL_4_SHFL
#define FIELD_LINEAR_DUAL_KERNEL_4_SHFL

//warp_shfl: LTX >= 2, LBX >= 3
#define field_linear_dual4_shfl(stream, LBX, LBY, LTX, LTY, X1, X2, alpha, beta, gamma, N, M, V, width, stride) \
	field_linear_dual_kernel_4_shfl<LBX, LBY>\
		<<< dim3(N>>LBX>>LTX, M>>LBY>>LTY), dim3(1<<LBX, 1<<LBY), 0, stream >>>\
			(X1, X2, alpha, beta, gamma, N, M, V, width, stride)

template<int LBX, int LBY>
__global__ void field_linear_dual_kernel_4_shfl(
