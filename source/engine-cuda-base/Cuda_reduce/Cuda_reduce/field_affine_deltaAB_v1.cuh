...
//[16, 4]
#define field_affine_deltaAB_v1_k4_small(stream, deltaY, Y, A, B, N, M, deltaA, deltaB, width, stride) \
...
//LTX >=2
#define field_affine_deltaAB_v1_k4(stream, LBY, LBX, LTY, LTX, deltaY, Y, A, B, N, M, deltaA, deltaB, width, stride) \
