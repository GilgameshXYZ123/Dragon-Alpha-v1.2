...
#ifndef MAT_MUL4X_T1_MICRO
#define MAT_MUL4X_T1_MICRO
	...
	int N, int M, int K, int SA, int SB)
{
	...
	if ((N > 127) && (M > 127) && (K > 7)) {//[128, 128]
 		k88T1(4, stream, A, B, C, N, M, K, SA, SB); 
		mm4xT1_Branch(127, 127); return;
	} 
	if ((N > 63) && (M > 63)) {//[64, 64], K % 4 == 0
		if (!(K & 3)) k88T1_mgk(3, stream, A, B, C, N, M, K, SA, SB);//K % 4 == 0
		else k88T1(3, stream, A, B, C, N, M, K, SA, SB); 
		mm4xT1_Branch(63, 63); return; 
	}

	if ((N > 63) && (M > 31)) { k84T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(63, 31); return; }
	if ((N > 31) && (M > 63)) { k48T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(31, 63); return; }

	if ((N > 31) && (M > 31)) { k44T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(31, 31); return; }

	if ((N > 63) && (M > 15)) { k82T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(63, 15); return; }
	if ((N > 15) && (M > 63)) { k28T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(15, 63); return; }

	if ((N > 31) && (M > 15)) { k42T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(31, 15); return; }
	if ((N > 15) && (M > 31)) { k24T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(15, 31); return; }
		
	if (K > 7) {
		if ((N > 63) && (M >  7)) { k81T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(63, 7); return; }
		if ((N > 15) && (M > 15)) { k22T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(15, 15); return; }
		if ((N >  7) && (M > 63)) { k18T1(3, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(7, 63); return; }
	}

	if ((N > 31) && (M > 15)) { k84T1(2, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(31, 15); return; }
	if ((N > 15) && (M > 31)) { k48T1(2, stream, A, B, C, N, M, K, SA, SB); mm4xT1_Branch(15, 31); return; }
...
#ifndef MAT_MUL4X_T1_SK_MICRO
#define MAT_MUL4X_T1_SK_MICRO
	...
	int SA, int SB)
{
	...
	if ((N > 127) && (M > 127)) { 
		k88T1SK(4, GZ, stream, A, B, C, Cbuf, N, M, K, SA, SB);
