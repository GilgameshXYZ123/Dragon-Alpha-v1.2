...
//Method:    matMulSK
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_math_Cuda_1matMul_matMulSK(JNIEnv *env, jclass cls,
...
//Method:    matMulT2SK
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_math_Cuda_1matMul_matMulT2SK(JNIEnv *env, jclass cls,
	jlongArray streamArray, jint length, jint GridZ,
	jlong dA_address,
	jlong dB_address,
	jlong dC_address, jlong dCbuf_address,
