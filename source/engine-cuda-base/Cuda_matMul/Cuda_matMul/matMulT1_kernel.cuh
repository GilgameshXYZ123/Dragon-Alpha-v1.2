...
#define	k88T1(LB, stream, A, B,  C, N, M, K, SA, SB) \
	kernel_t1_8_8<LB, (1<<LB>>1), (1<<LB>>1)-1>\
		<<< dim3(M>>3>>LB, N>>3>>LB), dim3(2<<LB, 1<<LB>>1), 0, stream >>>\
			(A, B, C, SA, SB, K)
...
//for [2048 * 2048 * 2048]:
//LB = 4: Size = 8, Time = 1.615 msec, Performace = 10637.7 GFlop/s
//LB = 3: Size = 8, Time = 1.689 msec, Performace = 10171.6 GFlop/s
//for [4096 * 4096 * 4096]:
	...
	int SA, int SB, int K)
{
	...
	//compute area-------------------------------------------------------
	int A0 = ty * SA + bY + (tx << 2);
	int B0 = ty * SB + bX + (tx << 2);
...
//for [2048 * 2048 * 2048]:
//LB = 4: Size = 8.01562, Time = 1.504 msec, Performace = 11445.1 GFlop/s
//LB = 3: Size = 8.01562, Time = 1.677 msec, Performace = 10264.4 GFlop/s
//for [4096 * 4096 * 4096]:
//LB = 4: Size = 64.125, Time = 11.93 msec, Performace = 11542.9 GFlop/s
