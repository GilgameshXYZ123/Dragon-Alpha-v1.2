...
//lengthv > lengthv_max
#define quadratic_dual2d_k4_max(stream, X1, X2, k11, k12, k22, k1, k2, C, Y, lengthv, width, stride)\
	quadratic_dual2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { quadratic_dual2d_k4_max(stream, X1, X2, k11, k12, k22, k1, k2, C, Y, lengthv, width, stride); return; }
