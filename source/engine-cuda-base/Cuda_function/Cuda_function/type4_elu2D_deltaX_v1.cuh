...
//lengthv > lengthv_max
#define elu2d_deltaX_v1_k4_max(stream,  deltaX, deltaY, Y, alpha, k, lengthv, width, stride)\
	elu2D_deltaX_v1_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { elu2d_deltaX_v1_k4_max(stream, deltaX, deltaY, Y, alpha, k, lengthv, width, stride); return; }
