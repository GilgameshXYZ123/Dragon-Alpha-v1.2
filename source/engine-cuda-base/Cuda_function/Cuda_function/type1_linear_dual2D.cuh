...
//lengthv > lengthv_max
#define linear_dual2d_k4_max(stream, X1, X2, alpha, beta, gamma, Y, lengthv, width, stride)\
	linear_dual2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { linear_dual2d_k4_max(stream, X1, X2, alpha, beta, gamma, Y, lengthv, width, stride); return; }
