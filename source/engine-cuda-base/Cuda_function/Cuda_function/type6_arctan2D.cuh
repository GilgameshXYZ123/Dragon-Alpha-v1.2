...
//lengthv > lengthv_max
#define arctan2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride)\
	arctan2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { arctan2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride); return; }
