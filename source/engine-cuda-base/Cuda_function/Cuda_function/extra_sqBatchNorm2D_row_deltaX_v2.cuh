...
//lengthv > lengthv_max
#define sqBatchNorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	sqBatchNorm2D_row_deltaX_v2_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sqBatchNorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
