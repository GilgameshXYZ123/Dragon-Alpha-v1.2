...
//lengthv > lengthv_max
#define sgdmn2d_decay_k4_max(stream, W, V, momentum, dampen, nesterov, deltaW, lr, L1coef, L2coef, lengthv, width, stride)\
	sgdmn2D_decay_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sgdmn2d_decay_k4_max(stream, W, V, momentum, dampen, nesterov, deltaW, lr, L1coef, L2coef, lengthv, width, stride); return; }
