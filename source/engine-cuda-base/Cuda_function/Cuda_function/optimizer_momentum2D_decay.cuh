...
//lengthv > lengthv_max
#define momentum2d_decay_k4_max(stream, W, V, a1, a2, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride)\
	momentum2D_decay_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { momentum2d_decay_k4_max(stream, W, V, a1, a2, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride); return; }
