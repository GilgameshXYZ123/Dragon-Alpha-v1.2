...
//lengthv > lengthv_max
#define softmax_crossEntropy_2d_k4_max(stream, Y, X, maxX, expXm_max_rowSum, row_lengthv, L, lengthv, width, stride)\
	softmax_crossEntropy_2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { softmax_crossEntropy_2d_k4_max(stream, Y, X, maxX, expXm_max_rowSum, row_lengthv, L, lengthv, width, stride); return; }
