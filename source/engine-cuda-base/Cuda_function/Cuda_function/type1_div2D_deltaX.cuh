...
//lengthv > lengthv_max
#define div2d_deltaX_k4_max(stream, deltaX1, deltaX2, deltaY, X1, alpha11, beta1, X2, alpha2, beta2, lengthv, width, stride)\
	div2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { div2d_deltaX_k4_max(stream, deltaX1, deltaX2, deltaY, X1, alpha1, beta1, X2, alpha2, beta2, lengthv, width, stride); return; }
