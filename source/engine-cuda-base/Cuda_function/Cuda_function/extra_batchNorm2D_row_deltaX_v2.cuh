...
//lengthv > lengthv_max
#define batchNorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	batchNorm2D_row_deltaX_v2_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { batchNorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
