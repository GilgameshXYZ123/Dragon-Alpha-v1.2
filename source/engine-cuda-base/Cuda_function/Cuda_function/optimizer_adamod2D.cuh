...
//lengthv > lengthv_max
#define adamod2d_k4_max(stream, W, V, a1, a2, S, b1, b2, eps_t, G, c1, c2, deltaW, lr_t, lengthv, width, stride)\
	adamod2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { adamod2d_k4_max(stream, W, V, a1, a2, S, b1, b2, eps_t, G, c1, c2, deltaW, lr_t, lengthv, width, stride); return; }
