...
//lengthv > lengthv_max
#define quadratic_dual2d_deltaX_k4_max(stream, deltaX1, deltaX2, deltaY, X1, X2, k11, k12, k22, k1, k2, lengthv, width, stride)\
	quadratic_dual2D_deltaX_kernel_4\
...
//<1> dY / dX1 = k11*2*X1 + k12*X2 + k1
//<2> dY / dX2 = k22*2*X2 + k12*X1 + k2
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { quadratic_dual2d_deltaX_k4_max(stream, deltaX1, deltaX2, deltaY, X1, X2, k11, k12, k22, k1, k2, lengthv, width, stride); return; }
