...
//lengthv > lengthv_max
#define logsoftmax2d_k4_max(stream, X, maxX, expXm_max_rowSum, row_lengthv, Y, lengthv, width, stride)\
	logsoftmax2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { logsoftmax2d_k4_max(stream, X, maxX, expXm_max_rowSum, row_lengthv, Y, lengthv, width, stride); return; }
