...
//lengthv > lengthv_max
#define batchNorm2d_row_k4_max(stream, X, X_mean, X_var, eps, row_lengthv, Y, lengthv, width, stride)\
	batchNorm2D_row_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { batchNorm2d_row_k4_max(stream, X, X_mean, X_var, eps, row_lengthv, Y, lengthv, width, stride); return; }
