...
//lengthv > lengthv_max
#define sin2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride)\
	sin2D_kernel_4\
...
#ifndef SIN_2D_KERNEL4
#define SIN_2D_KERNEL4
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sin2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride); return; }
