...
//lengthv > lengthv_max
#define softmax_crossEntropy_2d_deltaX_k4_max(stream, Y, X, maxX, expXm_max_rowSum, Y_rowSum, row_lengthv, deltaX, lengthv, width, stride)\
	softmax_crossEntropy_2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { softmax_crossEntropy_2d_deltaX_k4_max(stream, Y, X, maxX, expXm_max_rowSum, Y_rowSum, row_lengthv, deltaX, lengthv, width, stride); return; }
