...
//lengthv > lengthv_max
#define sigmoid_binaryCrossEntropy2d_deltaX_k4_max(stream, Y, X, alpha, beta, deltaX, lengthv, width, stride)\
	sigmoid_binaryCrossEntropy2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sigmoid_binaryCrossEntropy2d_deltaX_k4_max(stream, Y, X, alpha, beta, deltaX, lengthv, width, stride); return; }
