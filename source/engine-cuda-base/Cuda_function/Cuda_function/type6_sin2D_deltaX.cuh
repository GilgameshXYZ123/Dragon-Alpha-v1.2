...
//lengthv > lengthv_max
#define sin2d_deltaX_k4_max(stream,  deltaX, deltaY, X, alpha, beta, lengthv, width, stride)\
	sin2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sin2d_deltaX_k4_max(stream, deltaX, deltaY, X, alpha, beta, lengthv, width, stride); return; }
