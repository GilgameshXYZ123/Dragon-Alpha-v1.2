...
//lengthv > lengthv_max
#define tan2d_deltaX_k4_max(stream, deltaX, deltaY, Y, alpha, lengthv, width, stride)\
	tan2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { tan2d_deltaX_k4_max(stream, deltaX, deltaY, Y, alpha, lengthv, width, stride); return; }
