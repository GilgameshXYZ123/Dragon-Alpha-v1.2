...
//lengthv > lengthv_max
#define halfsin2d_k4_max(stream, Amp, alpha, X, beta, Y, lengthv, width, stride)\
	halfsin2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { halfsin2d_k4_max(stream, Amp, alpha, X, beta, Y, lengthv, width, stride); return; }
