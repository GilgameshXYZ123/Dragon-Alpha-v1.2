...
//lengthv > lengthv_max
#define arcsin2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride)\
	arcsin2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { arcsin2d_k4_max(stream, alpha, X, beta, Y, lengthv, width, stride); return; }
