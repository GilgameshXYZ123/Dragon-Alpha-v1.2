...
//lengthv > lengthv_max
#define variance2d_f64_k4_max(stream, X_mean, X_sqmean, X_var, lengthv, width, stride)\
	variance2D_f64_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { variance2d_f64_k4_max(stream, X_mean, X_sqmean, X_var, lengthv, width, stride); return; }
