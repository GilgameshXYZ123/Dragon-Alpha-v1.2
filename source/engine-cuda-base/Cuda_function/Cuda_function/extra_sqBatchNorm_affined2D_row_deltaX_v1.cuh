...
//lengthv > lengthv_max
#define sqBatchNorm_affined2d_row_deltaX_v1_k4_max(stream, deltaY, Y, X_mean, X_sqmean, eps, A, B, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	sqBatchNorm_affined2D_row_deltaX_v1_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sqBatchNorm_affined2d_row_deltaX_v1_k4_max(stream, deltaY, Y, X_mean, X_sqmean, eps, A, B, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
