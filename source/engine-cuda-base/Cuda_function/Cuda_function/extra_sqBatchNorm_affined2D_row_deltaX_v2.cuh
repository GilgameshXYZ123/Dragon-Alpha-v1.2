...
//lengthv > lengthv_max
#define sqBatchnorm_affined2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_sqmean, eps, A, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	sqBatchNorm_affined2D_row_deltaX_v2_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sqBatchnorm_affined2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_mean, X_sqmean, eps, A, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
