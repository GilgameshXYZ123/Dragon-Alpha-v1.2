...
//lengthv > lengthv_max
#define adamax2d_decay_k4_max(stream, W, V, a1, a2, S, b1, eps, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride)\
	adamax2D_decay_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { adamax2d_decay_k4_max(stream, W, V, a1, a2, S, b1, eps, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride); return; }
