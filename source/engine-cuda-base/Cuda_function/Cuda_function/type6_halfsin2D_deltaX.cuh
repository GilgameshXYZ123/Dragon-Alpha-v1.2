...
//lengthv > lengthv_max
#define halfsin2d_deltaX_k4_max(stream,  deltaX, deltaY, Y, Amp, alpha, lengthv, width, stride)\
	halfsin2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { halfsin2d_deltaX_k4_max(stream, deltaX, deltaY, Y, Amp, alpha, lengthv, width, stride); return; }
