...
//lengthv > lengthv_max
#define div2d_k4_max(stream, alpha1, X1, beta1, alpha2, X2, beta2, gamma, Y, lengthv, width, stride)\
	div2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { div2d_k4_max(stream, alpha1, X1, beta1, alpha2, X2, beta2, gamma, Y, lengthv, width, stride); return; }
