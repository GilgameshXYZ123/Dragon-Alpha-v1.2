...
//lengthv > lengthv_max
#define logsoftmax2d_deltaX_k4_max(stream,  deltaX, deltaY, Y, deltaY_rowSum, row_lengthv, lengthv, width, stride)\
	logsoftmax2D_deltaX_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { logsoftmax2d_deltaX_k4_max(stream, deltaX, deltaY, Y, deltaY_rowSum, row_lengthv, lengthv, width, stride); return; }
