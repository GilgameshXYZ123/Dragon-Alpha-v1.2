...
//lengthv > lengthv_max
#define linear_dual2d_field_k4_max(stream, X1, X2, row_lengthv, alpha, beta, gamma, Y, lengthv, width, stride)\
	linear_dual2D_field_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { linear_dual2d_field_k4_max(stream, X1, X2, row_lengthv, alpha, beta, gamma, Y, lengthv, width, stride); return; }
