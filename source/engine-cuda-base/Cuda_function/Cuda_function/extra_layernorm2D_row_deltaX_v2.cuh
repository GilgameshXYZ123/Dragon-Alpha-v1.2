...
//lengthv > lengthv_max
#define layernorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_row_mean, X_row_square_mean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	layernorm2D_row_deltaX_v2_kernel_4\
...
void __layernorm2D_row_deltaX_v2(cudaStream_t stream,
	...
	int lengthv, int width, int stride)
{
	if (lengthv < 256) { layernorm2d_row_deltaX_v2_k4_small(stream, deltaY, X, X_row_mean, X_row_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
	if (lengthv > LENGTHV_MAX) { layernorm2d_row_deltaX_v2_k4_max(stream, deltaY, X, X_row_mean, X_row_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
	layernorm2d_row_deltaX_v2_k4(stream, 5, 2, deltaY, X, X_row_mean, X_row_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride);
}
