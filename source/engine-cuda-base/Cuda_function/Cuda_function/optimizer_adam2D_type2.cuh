...
#define adam2d_k4_max_type2(stream, W, V, a1, a2, Uv, S, b1, b2, eps, Us, deltaW, lr, lengthv, width, stride)\
	adam2D_kernel_4_type2\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { adam2d_k4_max_type2(stream, W, V, a1, a2, Uv, S, b1, b2, eps, Us, deltaW, lr, lengthv, width, stride); return; }
