...
//lengthv > lengthv_max
#define affine2d_row_k4_max(stream, X, A, B, row_lengthv, Y, lengthv, width, stride)\
	affine2D_row_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { affine2d_row_k4_max(stream, X, A, B, row_lengthv, Y, lengthv, width, stride); return; }
