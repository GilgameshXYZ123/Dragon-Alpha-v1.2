...
//lengthv > lengthv_max
#define max_dual2d_k4_max(stream, alpha1, X1, beta1, alpha2, X2, beta2, Y, lengthv, width, stride)\
	max_dual2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { max_dual2d_k4_max(stream, alpha1, X1, beta1, alpha2, X2, beta2, Y, lengthv, width, stride); return; }
