...
//lengthv > lengthv_max
#define crossEntropy_2d_deltaYh_k4_max(stream, Y, Yh, deltaYh, lengthv, width, stride)\
	crossEntropy_2D_deltaYh_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { crossEntropy_2d_deltaYh_k4_max(stream, Y, Yh, deltaYh, lengthv, width, stride); return; }
