...
//lengthv > lengthv_max
#define rpl2d_k4_max(stream, alpha, X, beta, gamma, Y, lengthv, width, stride)\
	rpl2D_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { rpl2d_k4_max(stream, alpha, X, beta, gamma, Y, lengthv, width, stride); return; }
