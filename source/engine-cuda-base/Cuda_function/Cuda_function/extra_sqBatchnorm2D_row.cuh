...
//lengthv > lengthv_max
#define sqBatchNorm2d_row_k4_max(stream, X, X_mean, X_sqmean, eps, row_lengthv, Y, lengthv, width, stride)\
	sqBatchNorm2D_row_kernel_4\
	...
	int lengthv, int width, int stride)
{
	...
	if (lengthv > LENGTHV_MAX) { sqBatchNorm2d_row_k4_max(stream, X, X_mean, X_sqmean, eps, row_lengthv, Y, lengthv, width, stride); return; }
