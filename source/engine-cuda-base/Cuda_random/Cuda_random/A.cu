...
#include "random_leakyRelu_bernouli_mul2D.cuh"
...
JNIEXPORT void JNICALL Java_z_dragon_engine_cuda_impl_math_Cuda_1random_leakyRelu_1bernouli_1mul2D(JNIEnv *env, jclass cls,
	jlong stream_address,
	jlong dX_address,
	jlong dR_address, jlong dY_address, jfloat k, 
	jint seed, 
	jfloat p, jfloat v1, jfloat v2, 
	jint lengthv, jint width, jint stride)
{
