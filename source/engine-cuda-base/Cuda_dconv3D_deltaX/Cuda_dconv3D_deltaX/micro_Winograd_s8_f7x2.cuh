...
#ifndef MICRO_WINOGRAD_F7X2_H
#define MICRO_WINOGRAD_F7X2_H

//======{ Filtrer-Transform: W(2) -> G(8) }==========
//[   1,       0]
//[-2/9,    -2/9]
//[-2/9,     2/9]
//[1/90,    1/45]
...
//[32/45, -16/45]
//[   0,      1 ]
#define winograd_f7x2_g(g, w0, w1) {\
	g[0] = w0;\
	g[1] = -0.22222222f * (w0 + w1);\
	g[2] = -0.22222222f * (w0 - w1);\
	g[3] = 0.01111111f*w0 + 0.02222222f*w1;\
	g[4] = 0.01111111f*w0 - 0.02222222f*w1;\
	g[5] = 0.71111111f*w0 + 0.35555556f*w1;\
	g[6] = 0.71111111f*w0 - 0.35555556f*w1;\
	g[7] = w1;}
...
#define winograd_f7x2_y(y, a) {\
	...
	y[5] =        a[1] - a[2] + 32.0f*a[3] - 32.0f*a[4] + 0.03125f *a[5] - 0.03125f *a[6];\
	y[6] =        a[1] + a[2] + 64.0f*a[3] + 64.0f*a[4] + 0.015625f*a[5] + 0.015625f*a[6] + a[7]; }
...
#define winograd_f7x2_Y(y, a) {\
	...
	y[5] =        t1 + 32.0f*t3 + 0.03125f *t5;\
	y[6] =        t0 + 64.0f*t2 + 0.015625f*t4 + a[7]; }

//optimized: with less multiplications
//for vector type
#define winograd_f7x2_Y_vec(y, a, elem) {\
	...
	y[4] =             t0 + 16.0f*t2 + 0.0625f  *t4;\
	y[5] =             t1 + 32.0f*t3 + 0.03125f *t5;\
	y[6] =             t0 + 64.0f*t2 + 0.015625f*t4 + a[7].elem; }
