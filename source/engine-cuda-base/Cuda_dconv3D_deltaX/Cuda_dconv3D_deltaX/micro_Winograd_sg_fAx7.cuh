...
#ifndef MICRO_WINOGRAD_FAX7_H
#define MICRO_WINOGRAD_FAX7_H

const bool enable_Winograd_F10X7 = true;

//======{ Filtrer-Transform: W(7) -> G(16) }==========
//with less multiplication
#define winograd_f10x7_G(g, w) {\
	float t1, t2;\
	g[0] = w[0];\
	t1 = -2.222222E-03f * (w[0] + w[2] + w[4] + w[6]);\
	t2 = -2.222222E-03f * (w[1] + w[3] + w[5]);\
	g[1] = t1 + t2; g[2] = t1 - t2;\
	t1 =  1.209373E-05f * w[0] + 4.837491E-05f * w[2] + 1.934996E-04f * w[4] + 7.739985E-04f * w[6];\
	t2 =  2.418745E-05f * w[1] + 9.674981E-05f * w[3] + 3.869993E-04f * w[5];\
	g[3] = t1 + t2; g[4] = t1 - t2;\
	t1 =  1.981436E-01f * w[0] + 4.953590E-02f * w[2] + 1.238398E-02f * w[4] + 3.095994E-03f * w[6];\
	t2 =  9.907181E-02f * w[1] + 2.476795E-02f * w[3] + 6.191988E-03f * w[5];\
	g[5] = t1 + t2; g[6] = t1 - t2;\
	t1 = -2.854289E-07f * w[0] - 2.568860E-06f * w[2] - 2.311974E-05f * w[4] - 2.080776E-04f * w[6];\
	t2 = -8.562866E-07f * w[1] - 7.706579E-06f * w[3] - 6.935922E-05f * w[5];\
	g[7] = t1 + t2; g[8] = t1 - t2;\
	t1 = -1.365197E+00f * w[0] - 1.516886E-01f * w[2] - 1.685429E-02f * w[4] - 1.872699E-03f * w[6];\
	t2 = -4.550658E-01f * w[1] - 5.056287E-02f * w[3] - 5.618096E-03f * w[5];\
	g[9] = t1 + t2; g[10] = t1 - t2;\
	t1 =  6.218494E-09f * w[0] + 9.949590E-08f * w[2] + 1.591934E-06f * w[4] + 2.547095E-05f * w[6];\
	t2 =  2.487397E-08f * w[1] + 3.979836E-07f * w[3] + 6.367738E-06f * w[5];\
	g[11] = t1 + t2; g[12] = t1 - t2;\
	t1 =  1.669264E+00f * w[0] + 1.043290E-01f * w[2] + 6.520563E-03f * w[4] + 4.075352E-04f * w[6];\
	t2 =  4.173160E-01f * w[1] + 2.608225E-02f * w[3] + 1.630141E-03f * w[5];\
...
//======{ Ouput-Transform: A[16] -> Y[10] }==========
//with less multiplication
#define winograd_f10x7_Y(y, a) {\
	...
	y[ 9] = t2 +  512.0f*t4 + 0.001953125f*t6 +   19683.0f*t8 + 5.080526E-5f*t10 +   262144.0f*t12 + 3.814697E-6f*t14 + a[15]; }
