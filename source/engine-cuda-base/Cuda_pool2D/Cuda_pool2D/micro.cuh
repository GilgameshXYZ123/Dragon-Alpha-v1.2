...
#define F32_MIN4 float4{ FLOAT_MIN, FLOAT_MIN, FLOAT_MIN, FLOAT_MIN }
#define F32_MIN2 float2{ FLOAT_MIN, FLOAT_MIN }
...
#define IS_DIV2 ((FH == 2) && (FW == 2) && (sh == 2) && (sw == 2) && (ph == 0) && (pw == 0))
