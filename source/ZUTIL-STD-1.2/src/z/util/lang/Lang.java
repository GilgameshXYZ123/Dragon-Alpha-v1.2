...
public final class Lang 
{
    ...
    private static final Converter doubleConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null : (T) Double.valueOf(val); }
    };
    private static final Converter intConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null : (T) Integer.valueOf(val); }
    };
    private static final Converter booleanConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null : (T) Boolean.valueOf(val); }
    };
    private static final Converter floatConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null : (T) Float.valueOf(val); }
    };
    private static final Converter longConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null : (T) Long.valueOf(val); }
    };
    private static final Converter byteConverter = new Converter() {
        @Override public <T> T convert(String val) { return val == null ? null :(T) Byte.valueOf(val); }
    };
    private static final Converter shortConverter = new Converter() {
        @Override public <T> T convert(String val) { return val==null? null: (T) Short.valueOf(val); }
    };
    private static final Converter stringConverter = new Converter() {
        @Override public <T> T convert(String val)  { return (T) val; }
    };
    private static final Converter clazzConverter = new Converter() {
        @Override public <T> T convert(String val) throws Exception { return (T) Class.forName(val); }
    };
    ...
    public static boolean isSubClass(Class subClass, Class superClass) {
        try { subClass.asSubclass(superClass); return true; }
    ...
    public static String toDetailString(Class clazz)  {
        ...
        sb.append("\nFunctions\n");
        Vector.append(sb, clazz.getDeclaredMethods());
        sb.append("}");
        return sb.toString();
    }
    ...
    //</editor-fold>
    public static Collection<Field> getExtensiveMemberFields(Class clazz) { return Lang.getExtensiceFields(clazz, fieldNotStatic); }
    public static Collection<Field> getExtensiveMemberFields(Class clazz, Consumer<Field> con) { return Lang.getExtensiceFields(clazz, fieldNotStatic, con); }
    public static Collection<Field> getExtensiveStaticFields(Class clazz) { return Lang.getExtensiceFields(clazz, fieldIsStatic); }
    public static Collection<Field> getExtensiveStaticFields(Class clazz, Consumer<Field> con) { return Lang.getExtensiceFields(clazz, fieldIsStatic, con); }
    public static Collection<Field> getExtensiveFinalFields(Class clazz) { return Lang.getExtensiceFields(clazz, fieldIsFinal); }
    public static Collection<Field> getExtensiveFinalFields(Class clazz, Consumer<Field> con) { return Lang.getExtensiceFields(clazz, fieldIsFinal, con); }
    public static Collection<Field> getExtensiveNotFinalFields(Class clazz) { return Lang.getExtensiceFields(clazz, fieldNotFinal); }
    public static Collection<Field> getExtensiveNotFinalFields(Class clazz, Consumer<Field> con) { return Lang.getExtensiceFields(clazz, fieldNotFinal, con); }
    ...
    private static Field StringBuilder_value = null;
    private static Field String_value = null;
    static {
        try {
