...
{         
    ...
    public static float log2(float x){ return (float) (Math.log(x) * RLOG2_F64); }
    
    public static final boolean is_nan(float x) { return x != x; }
    public static final boolean is_inf(float x) { return x == x && is_nan(x - x);  }
 ...
 The integral from +infinite to base for Function func.
    ...
    //</editor-fold>
    public static double integral(double start, double end, Function func) { return ExMath.integral(start, end, func, DEF_INTEGRAL_STEP); }
    public static double integralToPF(double start, Function func) { return ExMath.integralToPF(start, func, DEF_INTEGRAL_STEP); }
    public static double integralFromNF(double bound, Function func) { return ExMath.integralFromNF(bound, func, DEF_INTEGRAL_STEP); }
