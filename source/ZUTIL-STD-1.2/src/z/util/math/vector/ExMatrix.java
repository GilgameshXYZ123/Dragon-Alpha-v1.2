...
//            for(int y=30;y<40;y++)
            ...
            {
                int kx=8, ky=8, kz=8;
                double[][] a=Matrix.random_double_mat(kx, ky, 10);
                double[][] b=Matrix.random_double_mat(ky, kz, 10);
...
//                Matrix.multiply(c2, a, b);
    ...
    public static void test2() throws InterruptedException
    {
        ...
        {
            int x=i,y=i,z=i;
            double[][] a=Matrix.random_double_mat(x, y, 10);
            double[][] b=Matrix.random_double_mat(y, z, 10);
    ...
    public static void test3() {
        ...
        double[][] A = Matrix.random_double_mat(N, K);
        double[][] B = Matrix.random_double_mat(K, M);
        ...
        long dif = st.record().timeStamp_dif_millis();
    ...
    final static Eigens eigenJacbiCorRotation(double[][] x, int iterLimit, double precision)
    {
        ...
        double[][] vectors=Matrix.double_eye(n);//the Eigens Vectors
    ...
    {
        double[][] mt=Matrix.double_eye(x.length);
        double sum, cr, hr;
